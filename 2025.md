# Low- and no-code guide for contributing to Mautic
...
7. **Submit your contribution**
    ...
    Please follow this process for each contribution to ensure it counts towards Hacktoberfest or Mautic's contributions. The team will add the label `hacktoberfest-accepted` to relevant contributions, which will enable your contributions to be counted.
...
| Govind S Nair (@G0v1ndD3v) | [https://github.com/mautic/low-no-code/issues/159](https://github.com/mautic/low-no-code/issues/159) | Added Hindi translation for CalendarBundle messages |
| Govind S Nair (@G0v1ndD3v) | [https://github.com/mautic/low-no-code/issues/161](https://github.com/mautic/low-no-code/issues/161) | Added Hindi translation for CategoryBundle messages, flashes and validators |
| Govind S Nair (@G0v1ndD3v) | [https://github.com/mautic/low-no-code/issues/162](https://github.com/mautic/low-no-code/issues/162) | Added Hindi translation for ChannelBundle javascript, messages, and validators |
| Govind S Nair (@G0v1ndD3v) | [https://github.com/mautic/low-no-code/issues/163](https://github.com/mautic/low-no-code/issues/163) | Added Hindi translation for ChatBundle messages and validators |
| Govind S Nair (@G0v1ndD3v) | [https://github.com/mautic/low-no-code/issues/164](https://github.com/mautic/low-no-code/issues/164) | Added Hindi translation for ConfigBundle messages and flashes |
| Govind S Nair (@G0v1ndD3v) | [https://github.com/mautic/low-no-code/issues/174](https://github.com/mautic/low-no-code/issues/174) | Added Hindi translation for HelloWorldBundle messages |
...
| Oluwaseun Oladeji (@oluwaseunoladeji) | [https://github.com/mautic/low-no-code/issues/13](https://github.com/mautic/low-no-code/issues/13) | Added Community Improvement process for advancing Mautic users into volunteers |
