...
7. **Submit your contribution**
    ...
    3. In your forked repository, edit the relevant file for the current year, and add your contribution and a link to the issue at the [Ongoing contributions 2025](#ongoing-contributions-2025) section. Follow any instructions that are written regarding the formatting to use
...
When linking to your contribution, please write a descriptive title and use the full link of the GitHub issue, Jira issue, Knowledgebase article, or other reference, as in the examples below:
